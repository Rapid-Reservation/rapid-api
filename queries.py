...
GET_CUSTOMER_BY_EMAIL = "SELECT * FROM public.customer WHERE customer_email = %s;"
CREATE_NEW_CUSTOMER = "INSERT INTO public.customer (customer_name, customer_address, customer_phone, customer_email) VALUES (%s, %s, %s, %s);"
...
GET_CUSTOMER_ID_BY_EMAIL = "SELECT customer_id from public.customer where customer_email=%s"
